    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        ...
        <form action="{{ route('login.authenticate') }}" method="POST">
           ...
           <div class="mb-4">
                ...
                <input type="text" name="username" id="username" value="{{ old('username') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan username" required autofocus>
